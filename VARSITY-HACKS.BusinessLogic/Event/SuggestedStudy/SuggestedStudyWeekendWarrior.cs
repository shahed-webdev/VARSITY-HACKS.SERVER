...
public class SuggestedStudyWeekendWarrior :ISuggestedStudy
{
    ...
    public SuggestedStudyWeekendWarrior(DateTime startDate, DateTime endDate, DifficultyLevel difficulty, DayOfWeek[] days)
    {
        EventBreak = 30;
